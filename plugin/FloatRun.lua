...
vim.api.nvim_create_user_command("FloatTermPrev", function()
  require("FloatRun").float_term_prev()
end, {})

vim.api.nvim_create_user_command("FloatTermNext", function()
  require("FloatRun").float_term_next()
end, {})
